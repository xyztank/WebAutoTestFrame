...
class LoginAndGetCookie:
    _lb_normal_locator = (By.XPATH, '//*[@id="lbNormal"]')  # 点击密码登录
    ...
    _lb_app_locator = (By.XPATH, '//*[@id="lbApp"]')  # 返回主iframe
    ...
    def _login(self, username, password):
        # self._find(self._lb_normal_locator).click()
    ...
    def _write_cookie_to_txt(self):
        dict_cookies = self._driver.get_cookies()
    ...
    def login_by_cookie(self):
        list_cookies = self._read_cookie_txt()
